...
console.log("DARK-NIRO-MD SESSION ID DOWNLOADED ✅")
})})}
...
console.log("DARK NIRO MD CONNECTING ✅");
...
console.log('👨‍💻 DARK NIRO MD INSTALING....')
...
console.log('DARK NIRO MD CONNETED ✅')

let up = `DARK NIRO MD CONNECTED SUCCESSFUL ✅\n\nPREFIX: ${prefix}`;
...
if(senderNumber.includes("94788686470")){
if(isReact) return
m.react("🧑🏻‍💻")
}
//=============================================  
