...
console.log("Connecting DARK-NIRO-MD 👨‍💻...");
...
console.log('𝐃𝐀𝐑𝐊-𝐍𝐈𝐑𝐎-𝐌𝐃 connected to whatsapp ✅')

let up = `DARK-NIRO-MD CONNETED SUCCESSFULLY 🤭✅\n\nPREFIX:${prefix}`;
...
app.get("/", (req, res) => {
res.send("hey, DARK-NIRO-MD started💃💫");
});
